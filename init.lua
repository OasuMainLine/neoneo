...
do
  ...
  -- Diagnostic keymaps
  vim.keymap.set('n', '<leader>d', vim.diagnostic.open_float, { desc = 'Open the diagnostics popup' })
  ...
  custom_group = vim.api.nvim_create_augroup('custom_autocmds', {})
...
do
  ...
  --
  -- - sgrw) - [S]urround [A]dd [I]nner [W]ord [)]Paren
...
do
  ...
  if config.use_mason then require 'mason_config' end
end
